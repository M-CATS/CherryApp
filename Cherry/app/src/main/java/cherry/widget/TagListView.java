...
//		if ((v instanceof TagView)&&((TagView) v).isChecked()) {
//			((TagView) v).setTextColor(Color.parseColor("#ffffff"));
//			v.setBackgroundResource(R.drawable.tag_bg2);
//		}
//		else if((v instanceof TagView)&&!((TagView) v).isChecked()){
//			((TagView) v).setTextColor(Color.parseColor("#ff33b5e5"));
...
//		}
	...
	private void inflateTagView(final Tag t, boolean b) {
		...
		if (mTagViewTextColorResId <= 0) {
			int c = getResources().getColor(R.color.primary);
